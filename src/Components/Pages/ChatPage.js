...
const ChatPage = () => {
  ...
  useEffect(() => {
    ...
    socket.current.on("connect", () => {
      console.log("The new socket id is ", socket.current.id)
    });
    ...
    // if (currentChat) {
      socket.current.on("getMessage", (data) => {
        ...
        console.log('The user is chat is working')
        return () => {
          socket.current.off("getMessge", data);
  ...
  useEffect(() => {
    ...
    return () => {
      socket.current.off("getUsers", grabUser);
      // socket.current.disconnect("getUsers", grabUser);
